...
int main(int argc, char **argv)
{
    ...
    sensor_type = ORB_SLAM3::CameraType::RGBD;
    ORB_SLAM3::System SLAM(voc_file, settings_file, sensor_type);

    ImageGrabber igb(&SLAM);

    message_filters::Subscriber<sensor_msgs::Image> rgb_sub(node_handler, "rgb/image_raw", 100);
    message_filters::Subscriber<sensor_msgs::Image> depth_sub(node_handler, "depth_registered/image_raw", 100);
