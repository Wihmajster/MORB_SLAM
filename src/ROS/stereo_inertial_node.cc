...
int main(int argc, char **argv)
{
    ...
    sensor_type = ORB_SLAM3::CameraType::IMU_STEREO;
    ...
    ros::Subscriber sub_img_left = node_handler.subscribe("left/image_raw", 100, &ImageGrabber::GrabImageLeft, &igb);
    ros::Subscriber sub_img_right = node_handler.subscribe("right/image_raw", 100, &ImageGrabber::GrabImageRight, &igb);
